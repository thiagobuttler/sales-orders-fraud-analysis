...
class DataHandler:
    ...
    def load_pagamentos(self, path: str, compression: str) -> DataFrame:
        try:
            ...
            if df_pagamentos.isEmpty():
                logger.warning(f"O arquivo de {path} foi lido, mas não contém registros.")
    ...
    def load_pedidos(self, path: str, compression: str, header:bool, sep: str) -> DataFrame:
        try:
            ...
            logger.critical(f"Erro crítico na JVM (possível arquivo corrompito ou erro de memória): {e}")
